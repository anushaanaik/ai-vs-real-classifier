 ...
 *  - Rendering verdict, confidence bar, and probability breakdown
 */
...
// Click on drop zone (keyboard accessible too)
...
function renderResult(data) {
  ...
  // Confidence bar (animate after a tick so transition fires)
